...
import { createDueno, updateDueno, clearMessages, type Owner } from '../../../store/slices/adminSlice';
import { isRequired, isValidEmail, hasErrors } from '../../../utils/validators';
...
export const useOwnerForm = (ownerToEdit?: Owner | null, onSuccess?: () => void) => {
